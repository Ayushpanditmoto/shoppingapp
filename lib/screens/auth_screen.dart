...
import 'package:shoppingapp/reusable/navigation.dart';
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  const Color.fromARGB(255, 59, 47, 195).withOpacity(0.5),
                  const Color.fromARGB(255, 23, 144, 144).withOpacity(0.9),
                ],
    ...
    try {
      if (_authMode == AuthMode.login) {
        ...
        await Provider.of<Auth>(context, listen: false)
            ...
            .then(
              (value) => Navigation.pushReplacement(
